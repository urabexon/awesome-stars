...
- [kurrrru/DT-Patricia](https://github.com/kurrrru/DT-Patricia) - An exact one-to-many alignment library implemented on a Patricia Tree (Radix Tree, compressed trie) using O(nd) diagonal transition principles.
